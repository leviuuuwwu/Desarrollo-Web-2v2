...
export default function Perfil({ modal, toggleModal }) {
    ...
    const obtenerDatos = async () => {
      ...
      try {
        ...
        if (userDoc.exists()) {
          ...
          const nombre =
            data.fullName || data.nombreEmpresa || "No disponible";
          const telefono =
            data.phone || data.telefono || "No disponible";
  ...
  return (
    modal && (
      <div
        id="perfil-modal"
        className="absolute top-full right-0 mt-2 w-85 bg-white shadow-lg rounded p-6 z-50 border border-gray-300"
      >
